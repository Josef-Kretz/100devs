...
let cater = 7-1
let weed = 7-1
let totalCandies = bulb+cater+weed
console.log(totalCandies)
//Conditionals And Functions
//You have a charmander in your party. Charmander can only battle if the temperature is above 0 degrees celcius. Create one function that converts a Fahrenheit value to Celcius and another fuction that tells you wheither or not charmander can battle
function fToCelsius(temperature)
{
  return (temperature-32)*(5/9)
}

function charmanderCanFight(temperature)
{
  return fToCelsius(temperature)>0 ? true : false
}

console.log("Charmander, can you fight at 40 deg F?", charmanderCanFight(40) ? 'yes' : 'no')
console.log("Charmander, can you fight at 10 deg F?", charmanderCanFight(10) ? 'yes' : 'no')
//Loops
...
console.log("You're about to fight a top tier trainer! They have 6 Pokemon!!!")
battle(6)
